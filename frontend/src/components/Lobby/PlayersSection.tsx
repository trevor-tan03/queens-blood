...
const PlayersSection = () => {
  const { gameCode, players, leaveGame, readyUp, unready, currPlayer } =
    useSignalR();
  ...
  return (
    <div className="flex flex-col gap-3 flex-1 max-w-[300px] p-3 bg-slate-800 h-fit border border-orange-300 border-l-0">
      <section className="border border-orange-300 p-3 bg-slate-700 text-slate-700">
      ...
      <button
        className="flex gap-2 items-center ml-auto py-3 px-8 rounded-full text-slate-700 bg-slate-300 hover:bg-red-700 hover:text-slate-50 transition-colors justify-center duration-200 mt-auto"
        onClick={disconnect}
      >
        <BiExit />
        Leave
